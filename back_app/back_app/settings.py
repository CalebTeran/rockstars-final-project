"""
Django settings for back_app project.
...
SECRET_KEY = 'django-insecure-d1r8j=2w9zowv+9)hb(ix!&&pc#t7r9-v+2izt=*_@&%u+$8tb'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=int(30)),
